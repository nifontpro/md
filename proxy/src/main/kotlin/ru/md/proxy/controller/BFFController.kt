package ru.md.proxy.controller
...
import ru.md.proxy.utils.CookieUtils
import ru.md.proxy.webclient.UserWebClientBuilder
...
class BFFController(
	...
	@GetMapping("test_c")
	suspend fun testClient() = getDataFromRS("/user/test", accessToken = "", requestBody = RS(""))

//	getDataFromRS(uri: String, accessToken: String, requestBody: RS): ResponseEntity<Any>
