...
fun ICorChainDsl<ProductContext>.addProductSecondImageToDb(title: String) = worker {

	this.title = title
	on { state == ContextState.RUNNING }

	handle {
		baseImage = imageService.addSecondImage(productId = productId, baseImage = baseImage)
	}
